...
namespace Cinema.DAL.Migrations
{
    ...
    [Migration("20210421104537_AddTickets")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinema.DAL.Entities.Sessions.AdditionalProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cinema.DAL.Entities.SittingPlace", b =>
                {
                    ...
                    b.HasOne("Cinema.DAL.Entities.Ticket", null)
                        .WithMany("Places")
            ...
            modelBuilder.Entity("Cinema.DAL.Entities.Ticket", b =>
                {
                    b.HasOne("Cinema.DAL.Entities.Sessions.Session", "Session")
                        .WithMany()
                        .HasForeignKey("SessionId");
